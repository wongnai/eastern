...
def test_load():
    assert_format_equal(TEST_ROOT / 'load' / 'load.yaml',
                        TEST_ROOT / 'load' / 'expect.yaml')
...
def test_load_required():
    assert_format_equal(TEST_ROOT / 'load_required' / 'load.yaml',
...
def test_load_default_file():
    assert_format_equal(TEST_ROOT / 'load_default' / 'load.yaml',
